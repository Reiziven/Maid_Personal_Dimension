...
public class CustomDimensionConfig {
    ...
    public static CustomDimensionConfig parse(String configEntry) {
        try {
            ...
            ResourceLocation templateDimensionKey = ResourceLocation.parse(templateKey);
    ...
    private static List<CustomDimensionConfig> getDefaultDimensions() {
        return Arrays.asList(
            new CustomDimensionConfig(
                "void",
                "MAID ISLAND",
                ResourceLocation.fromNamespaceAndPath(Touhoulittlemaidpersonaldimension.MODID, "personal_dimension_type_void"),
                Touhoulittlemaidpersonaldimension.PERSONAL_DIMENSION_VOID_KEY.location()
            ),
            new CustomDimensionConfig(
                "normal",
                "OVERWORLD",
                ResourceLocation.fromNamespaceAndPath(Touhoulittlemaidpersonaldimension.MODID, "personal_dimension_type_normal"),
                Touhoulittlemaidpersonaldimension.PERSONAL_DIMENSION_NORMAL_KEY.location()
            ),
            new CustomDimensionConfig(
                "cherry",
                "CHERRY GROVE",
                ResourceLocation.fromNamespaceAndPath(Touhoulittlemaidpersonaldimension.MODID, "personal_dimension_type_cherry"),
                Touhoulittlemaidpersonaldimension.PERSONAL_DIMENSION_CHERRY_KEY.location()
            ),
            new CustomDimensionConfig(
                "nether",
                "NETHER",
                ResourceLocation.fromNamespaceAndPath(Touhoulittlemaidpersonaldimension.MODID, "personal_dimension_nether"),
                ResourceLocation.fromNamespaceAndPath(Touhoulittlemaidpersonaldimension.MODID, "personal_dimension_nether")
            ),
            new CustomDimensionConfig(
                "end",
                "THE END",
                ResourceLocation.fromNamespaceAndPath(Touhoulittlemaidpersonaldimension.MODID, "personal_dimension_end"),
                ResourceLocation.fromNamespaceAndPath(Touhoulittlemaidpersonaldimension.MODID, "personal_dimension_end")
            )
        );
    }
