...
public class ModConfigScreen {
    public static Screen create(Screen parent) {
        ...
        domainExpansion.addEntry(entryBuilder.startDoubleField(
                Component.literal("Cherry Domain: Tornado Density"),
                Config.CHERRY_DOMAIN_TORNADO_DENSITY.get())
                .setDefaultValue(5.0)
                .setMin(0.1)
                .setMax(10.0)
                .setTooltip(Component.literal("Density of the tornado swirl (0.1 = very sparse, 10.0 = very dense). Has no effect if tornado is disabled."))
                .setSaveConsumer(Config.CHERRY_DOMAIN_TORNADO_DENSITY::set)
                .build());
        domainExpansion.addEntry(entryBuilder.startBooleanToggle(
                Component.literal("Cherry Domain: Enable Cherryfication"),
                Config.CHERRY_DOMAIN_ENABLE_CHERRYFICATION.get())
                .setDefaultValue(true)
                .setTooltip(Component.literal("If false, Cherry Domain will not convert blocks/sheep/boats to cherry variants and will not spawn ambient cherry particles. Tornado swirl is unaffected."))
                .setSaveConsumer(Config.CHERRY_DOMAIN_ENABLE_CHERRYFICATION::set)
                .build());
        domainExpansion.addEntry(entryBuilder.startDoubleField(
