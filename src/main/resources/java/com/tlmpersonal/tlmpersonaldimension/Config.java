...
public static final ModConfigSpec.IntValue CHERRY_DOMAIN_VERTICAL_HALF;
        ...
        // Domain Expansion buff/debuff amplifiers (0 = level I, 1 = level II, etc.)
                ...
                public static final ModConfigSpec.BooleanValue CHERRY_DOMAIN_ENABLE_CHERRYFICATION;
                public static final ModConfigSpec.DoubleValue CHERRY_DOMAIN_TORNADO_DENSITY;
        ...
        static {
            ...
            BUILDER.pop();
                ...
                CHERRY_DOMAIN_ENABLE_CHERRYFICATION = BUILDER
                        .comment("If true, Cherry Domain converts nearby blocks into cherry variants, spawns cherry particles, and transforms sheep/boats. Set to false to disable all of that.")
                        .define("cherryDomainEnableCherryfication", true);
                CHERRY_DOMAIN_TORNADO_DENSITY = BUILDER
                        .comment("Controls the density of the cherry tornado swirl (0.1 = very sparse, 10.0 = very dense). Has no effect if cherryDomainEnableTornado is false.")
                        .defineInRange("cherryDomainTornadoDensity", 5.0, 0.1, 10.0);
                BUILDER.pop();
