...
public class Config {
    ...
    static {
        ...
        ALLOWED_ENTITIES = BUILDER.defineList("allowedEntities", () -> List.of("minecraft:player", "minecraft:item", "minecraft:experience_orb"), o -> o instanceof String);
        BLOCKED_ENTITIES = BUILDER.defineList("blockedEntities", ArrayList::new, o -> o instanceof String);
        BUILDER.pop();

        BUILDER.push("Advanced Protection");
        DAMAGE_SOURCE_BLACKLIST = BUILDER.defineList("damageSourceBlacklist", ArrayList::new, o -> o instanceof String);
        FALL_PROTECTION_Y = BUILDER.defineInRange("fallProtectionY", -64.0, -128.0, 320.0);
        BUILDER.pop();

        BUILDER.push("Teleportation Restrictions");
        DIMENSION_WHITELIST = BUILDER.defineList("dimensionWhitelist", () -> List.of("minecraft:overworld"), o -> o instanceof String);
        BUILDER.pop();
        ...
        USE_MAID_GUI_CONTROLS = BUILDER
                ...
                .define("useMaidGuiControls", true);
        BUILDER.pop();
    }
