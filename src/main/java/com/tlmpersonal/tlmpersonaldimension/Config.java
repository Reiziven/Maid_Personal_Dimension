...
public class Config {
        ...
        public static final ForgeConfigSpec.EnumValue<DimensionType> DIMENSION_TYPE;
        public static final ForgeConfigSpec.BooleanValue ENABLE_STRUCTURES;
        ...
        public static final ForgeConfigSpec.IntValue MAID_SPAWN_CHANCE;

        // YSM Maid Model Options
        public static final ForgeConfigSpec.BooleanValue USE_YSM_MODELS;
        public static final ForgeConfigSpec.ConfigValue<List<? extends String>> YSM_MODEL_IDS;

        // Entity Protection
        public static final ForgeConfigSpec.BooleanValue IMMEDIATE_REMOVAL;
        public static final ForgeConfigSpec.BooleanValue REMOVE_BLOCKED_ENTITIES;
        public static final ForgeConfigSpec.BooleanValue ALLOW_ALL_ENTITIES;
        public static final ForgeConfigSpec.BooleanValue DISABLE_HOSTILE_ENTITIES;
        public static final ForgeConfigSpec.BooleanValue ENTITY_WHITELIST_MODE;
        ...
        public static final ForgeConfigSpec.BooleanValue ENABLE_BLOCK_BUILDING;

        // Teleportation Restrictions
        public static final ForgeConfigSpec.ConfigValue<List<? extends String>> DIMENSION_WHITELIST;

        // Advanced Protection
        public static final ForgeConfigSpec.ConfigValue<List<? extends String>> DAMAGE_SOURCE_BLACKLIST;
        public static final ForgeConfigSpec.DoubleValue FALL_PROTECTION_Y;

        // Ground Level Teleportation
        public static final ForgeConfigSpec.BooleanValue TELEPORT_TO_GROUND;

        // Sleep and Spawn
        public static final ForgeConfigSpec.BooleanValue ALLOW_SET_SPAWN;

        // Maid Protection
        public static final ForgeConfigSpec.BooleanValue TAMED_MAID_PROTECTION_ENABLED;
        public static final ForgeConfigSpec.BooleanValue TAMED_MAID_PROTECTION;
        public static final ForgeConfigSpec.IntValue TAMED_MAID_PROTECTION_RANGE;
        public static final ForgeConfigSpec.IntValue TAMED_MAID_PROTECTION_COOLDOWN;
        public static final ForgeConfigSpec.DoubleValue TAMED_MAID_PROTECTION_POWER_POINTS_COST;
        public static final ForgeConfigSpec.IntValue TAMED_MAID_PROTECTION_XP_COST;
        public static final ForgeConfigSpec.BooleanValue ALL_MAID_PROTECTION;
        public static final ForgeConfigSpec.BooleanValue WILD_MAID_PROTECTION;
        public static final ForgeConfigSpec.BooleanValue MAID_AUTHORITY;
        public static final ForgeConfigSpec.BooleanValue MAID_TELEPORT_WITH_OWNER_DIMENSION;
        public static final ForgeConfigSpec.BooleanValue MAID_ATTACK_DISCARD;

        // Entity Teleportation with Items
        public static final ForgeConfigSpec.BooleanValue ALLOW_ENTITY_TELEPORT;
        public static final ForgeConfigSpec.BooleanValue MAID_TELEPORTER_ALLOW_ALL_ENTITIES;
        public static final ForgeConfigSpec.BooleanValue MAID_TELEPORTER_ENTITY_WHITELIST_MODE;
        public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MAID_TELEPORTER_ALLOWED_ENTITIES;
        public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MAID_TELEPORTER_BLOCKED_ENTITIES;
        public static final ForgeConfigSpec.BooleanValue MAID_TELEPORTER_EXCLUDE_BOSSES;

        // General Survival Options
        public static final ForgeConfigSpec.BooleanValue DISABLE_HUNGER;
        public static final ForgeConfigSpec.BooleanValue DISABLE_MAID_DEATH;
        public static final ForgeConfigSpec.BooleanValue DISABLE_PLAYER_DEATH;
        public static final ForgeConfigSpec.BooleanValue NATURAL_HEALING;
        public static final ForgeConfigSpec.BooleanValue BLOCK_HARMFUL_EFFECTS;
        public static final ForgeConfigSpec.BooleanValue MAID_EMIT_LIGHT;
        public static final ForgeConfigSpec.BooleanValue ENTITY_CANNOT_TARGET;

        // Personal Dimension Teleportation
        public static final ForgeConfigSpec.BooleanValue TELEPORT_HAS_COST;
        public static final ForgeConfigSpec.DoubleValue TELEPORT_COST_POWER_POINTS;
        public static final ForgeConfigSpec.IntValue TELEPORT_COST_XP;
        public static final ForgeConfigSpec.IntValue TELEPORT_JOIN_COOLDOWN;
        public static final ForgeConfigSpec.IntValue TELEPORT_LEAVE_COOLDOWN;

        // Private Dimension Settings
        public static final ForgeConfigSpec.BooleanValue PRIVATE_DIMENSION;

        // Entity Allowance via Maid
        public static final ForgeConfigSpec.BooleanValue ALLOW_CHEAT_CONFIGS;
        public static final ForgeConfigSpec.BooleanValue ALLOW_FREE_WHITELIST;
        public static final ForgeConfigSpec.BooleanValue ALLOW_ALLOW_ALL_ENTITIES;
        public static final ForgeConfigSpec.IntValue MAID_ENTITY_WHITELIST_COOLDOWN_MINUTES;
        public static final ForgeConfigSpec.DoubleValue WHITELIST_BLACKLIST_COST_POWER_POINTS;
        public static final ForgeConfigSpec.IntValue WHITELIST_BLACKLIST_COST_XP;
        public static final ForgeConfigSpec.DoubleValue ALLOW_ALL_COST_POWER_POINTS;
        public static final ForgeConfigSpec.IntValue ALLOW_ALL_COST_XP;
        public static final ForgeConfigSpec.DoubleValue DISABLE_HOSTILE_COST_POWER_POINTS;
        public static final ForgeConfigSpec.IntValue DISABLE_HOSTILE_COST_XP;
        public static final ForgeConfigSpec.DoubleValue DIMENSION_RULES_COST_POWER_POINTS;
        public static final ForgeConfigSpec.IntValue DIMENSION_RULES_COST_XP;

        // GUI Layout Options
        public static final ForgeConfigSpec.BooleanValue USE_MAID_GUI_CONTROLS;

        // Bauble Crafting
        public static final ForgeConfigSpec.BooleanValue DOMAIN_EXPANSION_BAUBLE_CRAFTABLE;
        public static final ForgeConfigSpec.BooleanValue CHERRY_DOMAIN_BAUBLE_CRAFTABLE;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_BAUBLE_CRAFTABLE;
        public static final ForgeConfigSpec.BooleanValue TETHERED_TELEPORT_BAUBLE_CRAFTABLE;

        // Domain Expansion Bauble
        public static final ForgeConfigSpec.BooleanValue DOMAIN_EXPANSION_ENABLED;
        public static final ForgeConfigSpec.IntValue DOMAIN_EXPANSION_COOLDOWN_SECONDS;
        public static final ForgeConfigSpec.IntValue DOMAIN_EXPANSION_DURATION_SECONDS;
        public static final ForgeConfigSpec.BooleanValue DOMAIN_EXPANSION_USE_DIMENSION_RULES;
        public static final ForgeConfigSpec.BooleanValue DOMAIN_EXPANSION_USE_ENTITY_PROTECTION;
        public static final ForgeConfigSpec.BooleanValue DOMAIN_EXPANSION_USE_ENTITY_FILTERING;
        public static final ForgeConfigSpec.BooleanValue CHERRY_DOMAIN_USE_DIMENSION_RULES;
        public static final ForgeConfigSpec.BooleanValue CHERRY_DOMAIN_USE_ENTITY_PROTECTION;
        public static final ForgeConfigSpec.BooleanValue CHERRY_DOMAIN_USE_ENTITY_FILTERING;
        public static final ForgeConfigSpec.BooleanValue CHERRY_DOMAIN_AFFECTS_OWNER;
public static final ForgeConfigSpec.IntValue CHERRY_DOMAIN_HORIZONTAL_RADIUS;
public static final ForgeConfigSpec.IntValue CHERRY_DOMAIN_VERTICAL_HALF;
        public static final ForgeConfigSpec.IntValue CHERRY_DOMAIN_RULES_BYPASS_CHANCE;
        public static final ForgeConfigSpec.BooleanValue CHERRY_DOMAIN_XP_COST_ENABLED;
        public static final ForgeConfigSpec.IntValue CHERRY_DOMAIN_XP_COST;
        public static final ForgeConfigSpec.IntValue CHERRY_DOMAIN_XP_COST_INTERVAL_SECONDS;
        public static final ForgeConfigSpec.BooleanValue DOMAIN_EXPANSION_XP_COST_ENABLED;
        public static final ForgeConfigSpec.IntValue DOMAIN_EXPANSION_XP_COST;
        public static final ForgeConfigSpec.IntValue DOMAIN_EXPANSION_XP_COST_INTERVAL_SECONDS;
        public static final ForgeConfigSpec.DoubleValue DOMAIN_EXPANSION_MIN_DISTANCE;
        public static final ForgeConfigSpec.BooleanValue DOMAIN_EXPANSION_ENABLE_BLOCK_BREAKING;
        public static final ForgeConfigSpec.BooleanValue CHERRY_DOMAIN_ENABLE_BLOCK_BREAKING;
        public static final ForgeConfigSpec.ConfigValue<String> DOMAIN_EXPANSION_STRUCTURE;
        // Domain Expansion buff/debuff amplifiers (0 = level I, 1 = level II, etc.)
                public static final ForgeConfigSpec.IntValue DOMAIN_EXPANSION_ALLY_STRENGTH;
                public static final ForgeConfigSpec.IntValue DOMAIN_EXPANSION_ALLY_REGEN;
                public static final ForgeConfigSpec.IntValue DOMAIN_EXPANSION_ALLY_RESISTANCE;
                public static final ForgeConfigSpec.IntValue DOMAIN_EXPANSION_ENEMY_WEAKNESS;
                public static final ForgeConfigSpec.IntValue DOMAIN_EXPANSION_ENEMY_SLOWNESS;
                public static final ForgeConfigSpec.BooleanValue CHERRY_DOMAIN_GENERATE_PINK_PETALS;
                public static final ForgeConfigSpec.BooleanValue CHERRY_DOMAIN_ENABLE_TORNADO;
                public static final ForgeConfigSpec.BooleanValue CHERRY_DOMAIN_ENABLE_CHERRYFICATION;
                public static final ForgeConfigSpec.DoubleValue CHERRY_DOMAIN_TORNADO_DENSITY;

        // Cat Familiar Bauble
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_EFFECT_COOLDOWN;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_CAN_ATTACK;
        public static final ForgeConfigSpec.IntValue CAT_FAMILIAR_REVIVAL_COOLDOWN;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_DETECT_HOSTILES;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_DETECT_HOSTILES_CHAT;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_TELEPORTS_TO_TARGET;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_PARTICLES;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_IGNORE_FOLLOW_RANGE_FOR_ATTACK;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_MIRROR_ATTACK;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_MIRROR_HEALTH;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_MIRROR_DEFENCE;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_ATTACKS_PLAYER_TARGETS;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_BAUBLE_PROXY;
        public static final ForgeConfigSpec.BooleanValue CAT_FAMILIAR_MIRROR_ATTACK_SPEED;
        public static final ForgeConfigSpec.DoubleValue CAT_FAMILIAR_ATTACK_RANGE_BONUS;

        // Custom Dimension Templates
        public static final ForgeConfigSpec.ConfigValue<List<? extends String>> CUSTOM_DIMENSION_TEMPLATES;
        public static final ForgeConfigSpec.ConfigValue<String> DEFAULT_DIMENSION_TYPE_ID;
        ...
        static {
            ...
            BUILDER.pop();
                ...
                CHERRY_DOMAIN_TORNADO_DENSITY = BUILDER
                        .comment("Density multiplier for the cherry tornado swirl particles. 1.0 = default, 0.5 = half as many, 2.0 = twice as many. Accepts decimal values.")
                        .defineInRange("cherryDomainTornadoDensity", 1.0, 0.1, 10.0);
                BUILDER.pop();
