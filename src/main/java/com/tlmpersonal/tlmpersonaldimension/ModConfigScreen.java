...
public class ModConfigScreen {
    public static Screen create(Screen parent) {
        ...
        domainExpansion.addEntry(entryBuilder.startBooleanToggle(
                ...
                .setDefaultValue(true)
                .setTooltip(Component.literal("If false, disables block conversion to cherry, cherry particles inside the domain, and sheep/boat conversion. The tornado swirl is unaffected."))
        ...
        domainExpansion.addEntry(entryBuilder.startDoubleField(
                ...
                .setMin(0.1)
                .setMax(10.0)
                .setTooltip(Component.literal("Density multiplier for the tornado swirl particles. 1.0 = default, 0.5 = half, 2.0 = double. Accepts decimal values."))
